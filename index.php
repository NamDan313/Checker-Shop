...
<body class="w3-content" style="max-width:1500px" onload="reloadgiohang()">
    <!-- Sidebar/menu -->
                ...
                <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
                    ...
                    <form class="w3-container">
                        <div class="w3-section">
                            ...
                            <script src="https://www.paypal.com/sdk/js?client-id=AV8_RUyAcgRpcbjtOBm708Vr9QfjzR7mlcgrquzQUjs7EdBXsvY0X-QasymyohYa-NztAqVjN22PV-5c&currency=USD"></script>
                            <!-- Set up a container element for the button -->
                            
                            <script>
                                var tongtien = document.getElementById('price').value;
                                paypal.Buttons({
